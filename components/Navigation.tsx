...
const Navigation: React.FC = () => {
  ...
  //     const navLinks = document.querySelectorAll('a.nav-link') as NodeListOf<HTMLAnchorElement>;
    

  //     navLinks.forEach(link => {
  //       const currentLink  = window.location.hash === '' ? window.location.hash+'#home' : window.location.hash;
  //       const linkHash = link.hash;
  //       const isActive = linkHash && currentLink=== `#${linkHash.slice(1)}`; // Remove the "#" from link.hash
  //       link.classList.toggle('text-toogle-primary', !!isActive);
  //     });
  //   };
  ...
  const handleDownload = async () => {
    try {
      const response = await fetch('../assets/Visiting_Card.jpg');
      ...
      <div className="max-w-6xl mx-auto px-4">
        <div className="flex justify-between items-center">
          ...
          <div className="hidden md:flex space-x-3">
            <a href="#home" className='nav-link py-2 px-2 text-secondary font-semibold transition duration-300  '>
              Home
            </a>
            <a href="#about" className='nav-link py-2 px-2 text-secondary font-semibold transition duration-300  '>
              About Us
            </a>
            <a href="#securityServices" className='nav-link py-2 px-2 text-secondary font-semibold transition duration-300  '>
              Services
            </a>
            <a href="#contacts" className='nav-link py-2 px-2 text-secondary font-semibold transition duration-300  '>
            Contact Us
            </a>
          </div>
